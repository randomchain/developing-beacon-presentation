...
\begin{frame}{Practicalities: Stopping in a Fair Way}
    \note{
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Patterns like this \textrightarrow{} standardized in usability apps (multiple implementations)
        \end{itemize}
    \end{multicols}
    }
...
\note{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item First, \textbf{Enumerate threats}: previous papers don't do this \textbf{up-front} and more casually mentions threats as an after-thought to their design.
            \item \textbf{Describe usage of beacon in real world context}: Other papers just lists use cases, and \textbf{not how to properly apply}
